  ...
  >
    <div>
      ...
      <div class="text-gray-600 dark-white-700 mb-6">
        问题反馈：surpassling&commat;gmail.com
      </div>
      <div class="text-gray-600 dark-white-700 mb-6">
        微信授权：surpassling
      </div>
    ...
    <div>
      ...
      <div class="mb-6">
        <a href="https://github.com/surpassling/nav" target="_blank">
          Nav
        </a>
      </div>
      <div class="mb-6">
        <a
          href="https://github.com/surpassling/beautiful-window"
          target="_blank"
        >
          Beautiful window
        </a>
...
>
  ...
  >
    <a
      href="https://github.com/surpassling"
      target="_blank"
      class="text-gray-600 hover:underline"
      >Author</a
    >
    <a
      href="https://github.com/surpassling/nav"
      target="_blank"
      class="text-gray-600 hover:underline"
      >Nav</a
    >
    <a
      href="https://github.com/surpassling/boomb"
      target="_blank"
      class="text-gray-600 hover:underline"
      >Boomb</a
    >
    ...
    >
    <a
      href="https://github.com/surpassling/tomato-work"
      target="_blank"
      class="text-gray-600 hover:underline"
      >Tomato work</a
    >
