...
[谁在使用？](https://official.xxxxxxxx.com/?id=3)

## 特性

- 🍰 内置 `800+` 优质网站
- 🍰 支持 [码云 Gitee](https://gitee.com/ling/nav)
- 🍰 支持 [GitLab](https://gitlab.com/surpassling/nav)
- 🍰 支持从浏览器书签导入
- 🍰 支持将数据导出到浏览器书签
- 🍰 支持 AI 翻译
- 🍰 支持用户提交新增、编辑、删除
...
|√ | | gitRepoUrl | 填写您的仓库地址 |
|√ | | branch | 部署分支 |
|√ | | imageRepoUrl | 图片仓库, 默认主仓库 `https://github.com/surpassling/image?branch=main` |
...
将路由地址修改为 `system` 即可进入，如: https://www.xxxxxxxx.com 修改为 https://www.xxxxxxxx.com/system
...
For commercial sites, themes, projects, and applications, keep your source code private/proprietary by purchasing a [Commercial License](https://official.xxxxxxxx.com/pricing).
